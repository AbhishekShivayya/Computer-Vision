...
# test example
kitti_img_path = 'D:\\Desktop Files\kitti\Test_images_4k_4.5k/'
kitti_label_path = 'D:\\Desktop Files\kitti\label files/'

# transformed lables to save path
kitti_label_tosave_path = 'D:\\Desktop Files\kitti\kitti_to_yolo/'
...
for index i in range(len(kitti_images)):
    ...
    for line in label_contents:
        ...
        if (len(data) == 15):
            ...
            if (class_str != 'DontCare'):
                ...
                line_to_write = str(class_str) + ' ' + str(x1) + ' ' + str(y1) + ' ' + str(
                    x2) + ' ' + str(y2) + '\n'
